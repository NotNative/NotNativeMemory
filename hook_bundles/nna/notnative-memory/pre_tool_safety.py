#!/usr/bin/env python3
"""
NotNativeMemory - PreToolUse safety-gate hook (NNA bundle).

Fires before NotNativeAgent dispatches a tool call. Inspects the tool
name and arguments against a small set of destructive patterns; if any
match, the hook exits 2 with a stderr reason, which NNA interprets as
...
action the model has already chosen.
