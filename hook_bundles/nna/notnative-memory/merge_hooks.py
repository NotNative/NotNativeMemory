...
def _write_hooks_env(target_dir: str, mcp_url: str) -> None:
    ...
    env_content = (
        ...
        "\n# VerbatimCapture (verbatim_capture.py)\n"
        "# Timeout for the MCP HTTP write, in seconds. Keep this above\n"
        "# first-use embedding/model warmup so the client does not disconnect\n"
        "# while NNM is still successfully storing the chunk.\n"
        "NNA_VERBATIM_CAPTURE_TIMEOUT_SECONDS=20\n"
